        ...
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              ...
              plan.isPopular ? 'border-[#D54067] border-2' : 'border-border',
              'flex flex-col',
              !plan.isPopular && 'mt-5',
              index === 0 || index === 2
          ...
          >
            {plan.isPopular && (
              <div className="bg-[#D54067] absolute top-0 right-0 flex items-center rounded-tr-xl rounded-bl-xl px-2 py-0.5">
            ...
            <div className="flex flex-1 flex-col">
              ...
              <Link
                ...
                className={cn(
                  ...
                  'hover:bg-primary hover:text-white hover:ring-primary transform-gpu ring-offset-current transition-all duration-300 ease-out hover:ring-2 hover:ring-offset-1',
                  plan.isPopular
                    ? 'bg-primary text-[#D54067]'
